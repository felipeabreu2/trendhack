      ...
      <div className="bg-white rounded-lg p-6 shadow">
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-sm text-gray-500">Taxa de curtidas: 316%</p>
          </div>
      ...
      <div className="bg-white rounded-lg p-6 shadow">
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-sm text-gray-500">Taxa de comentários: 0%</p>
          </div>
      ...
      <div className="bg-white rounded-lg p-6 shadow">
        <div className="flex justify-between items-start">
          <div>
            ...
            <h2 className="text-4xl font-bold">{stats.duracao}</h2>
          </div>
